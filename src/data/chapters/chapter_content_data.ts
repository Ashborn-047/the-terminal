...
export const chapterContents: Record<string, ChapterContent> = {
        ...
        sections: [
            ...
            },
            {
                ...
                bullets: [
                    ...
                    "`/term` to search, `:%s/old/new/g` to replace."
                ]
            }
        ]
    },
    'track1-ch05': {
        ...
        sections: [
            ...
            },
            {
                ...
                list: [
                    "**Missing -m** — creating a user with no home directory.",
                    "**Missing -a** — wiping out all supplementary groups with `usermod -G`.",
                    "**Direct Editing** — manually editing `/etc/passwd` instead of using tools.",
                    "**Orphaned Files** — deleting users without `-r`."
                ]
            },
            {
                type: 'summary',
                id: 'summary',
                heading: '15. Summary & Looking Ahead',
                content: "You now control the people on your system. Next, you'll learn to control what they can access: file permissions, ownership, and the UGO/RWX system.",
                bullets: [
                    "`useradd`/`usermod`/`userdel` for life-cycle management.",
                    "`passwd` and `chage` for security policies.",
                    "`/etc/passwd`, `/etc/shadow`, and `/etc/group` are the core files.",
                    "`sudo` and `visudo` for administrative delegation."
                ]
            }
        ]
    },
    ...
    'track1-ch07': { chapterId: 'track1-ch07', title: 'Monitoring and Managing Linux Processes', description: '', sections: [] },
    'track1-ch08': { chapterId: 'track1-ch08', title: 'Controlling Services and Daemons', description: '', sections: [] },
    'track1-ch09': { chapterId: 'track1-ch09', title: 'Configuring and Securing SSH', description: '', sections: [] },
    'track1-ch10': { chapterId: 'track1-ch10', title: 'Analyzing and Storing Logs', description: '', sections: [] },
    'track1-ch11': { chapterId: 'track1-ch11', title: 'Managing Enterprise Networking', description: '', sections: [] },
    'track1-ch12': { chapterId: 'track1-ch12', title: 'Archiving and Transferring Files', description: '', sections: [] },
    'track1-ch13': { chapterId: 'track1-ch13', title: 'Installing and Updating Software Packages', description: '', sections: [] },
    'track1-ch14': { chapterId: 'track1-ch14', title: 'Accessing Linux File Systems', description: '', sections: [] },
    'track1-ch15': { chapterId: 'track1-ch15', title: 'Analyzing Servers and Getting Support', description: '', sections: [] }
};
